...
<%@page import="CompalinDao.complaindao"%>
<%@page import="complainBean.complainbean"%>
...
<body>
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
		               	<ul class="nav navbar-nav">
							...
							<li  id="lmain">
	                         ...
	                         <li  id="lmain">
								<a href="about1.jsp">about us</a>
							</li>
							
								<li id="lmain">
						 	    <a href="service1.jsp">services</a>
							</li>
	...
	<div class="form-text">
					...
					<h1 id="c2">Welcome</h1>
						<p>Here You can see your all complains!</p>
		...
		<div class="clearfix"> </div>
			...
			<form action="complaincontroller" method="post" class="banner_form">
			...
			<%int i=1; %>
					...
					<%ArrayList<complainbean> c1=complaindao.getall(i1);
					%> 
					 <table   align="center" border="2" width="500" cellpadding="20" cellspacing="20">
					 <tr>
					 
					<h1> <td id="c3">Complain No</td>
					 <td id="c3">Service</td>
					 <td id="c3">Description</td>
					 <td id="c3">Time</td>
					 <td id="c3">Date</td>
					  <td id="c3">Block No</td>
					   <td id="c3">Flat No</td>
					      <td id="c3">Status</td></h1>
					   </h1>
				
					 
					  </tr>
					 
					 <%for(complainbean c:c1) 
					 { %>
					 <tr>
					<h2> <td id="c1"><%=i++  %></td>
					 <td id="c1"><%= c.getService() %></td>
					 <td id="c1"><%= c.getDescription() %></td>
					 <td id="c1"><%= c.getTime() %></td>
					 <td id="c1"><%= c.getDate() %></td>
					 <td id="c1"><%= c.getBn() %></td>
					  <td id="c1"><%= c.getFlat() %></td>
					  <td id="c1"><%=c.getStatus() %></td>
