			...
			<form action="complaincontroller" method="post" class="banner_form">
					...
					<div class="form-select sec-left">
							...
							<select name = "service">
								...
								<option value="4">Carpentary</option>
						...
						<div class="form-tx contact-field3">
							<label class="contact-form-text">COMPLAIN Description</label>
							<textarea placeholder="Please write your query here" name = "description" required=""></textarea>
						</div>
						
						<div class="form-select">
							<label class="contact-form-text">Select Time</label>
							<select name= "time">
								<option value="0">---- SELECT ----</option>
								...
								<option value= "5">6.30-10</option>
							</select>
						</div>
						
						<div class="form-select"> <br>
						<label class="contact-form-text">Select Date</label>
