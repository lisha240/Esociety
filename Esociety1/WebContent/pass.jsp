					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
		               	<ul class="nav navbar-nav">
							...
							<li  id="lmain">
							  ...
							  <li class="active"  	 id="lmain"> 
	
								<a href="pass.jsp">ChangePassword</a>
							</li>
...
%>
 	...
 	<form action="user" method="post" class="banner_form">
						...
						<div class="sec-right">
								<label class="contact-form-text">Re-Password</label>
								<input placeholder=" " name="pass2" type="password"   class="form-control" required="">
							</div>
						<input type="hidden" name="email" value="<%= u.getEmail() %>">
						<input type="hidden"  name="sq" value="<%=u.getSq()%>">
						<input type="hidden"  name="ans" value="<%=u.getAns()%>">
						
						<!-- 
							<div class="sec-right">
								<label class="contact-form-text">NewPasssword</label>
								<input placeholder=" " name="password" type="text" required="">
							</div>
							
								<div class="form-select sec-right">
								<label class="contact-form-text">Select Security Question</label>
								<select name="sq"> 
								...
								<option value="Who is your best friend?">Who is your best friend?</option>
									<option value="How many hours you are reading in day?">How many hours you are reading in day?</option>
								 </select>
								 
								 	<div class="form-select sec-right">
								<label class="contact-form-text">Your ans</label>
								<input placeholder=" " name="ans" type="text" required="">
							</div>
