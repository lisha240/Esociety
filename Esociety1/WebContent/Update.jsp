...
First Name : <input type="text" name="fname" value="<%= u.getFname()%>"><br><br>
Last Name : <input type="text" name="lname" value="<%= u.getLname()%>"><br><br>
Email : <input type="text" name="email" value="<%= u.getEmail()%>"><br><br>
Password : <input type="password" name="pass" value="<%= u.getPass()%>"><br><br>
				         		
						
Mobile no: <input type="text"  name="mobno" value="<%= u.getMobno() %>"><br><br>

Block no:<input type="text"  name="bn" value="<%= u.getBn() %>"><br><br>

Flat no:<input type="text"  name="flat" value="<%= u.getFlat()%>"><br><br>

Security Question:		<input type="text"  name="sq" value="<%= u.getSq() %>"><br><br>		

Answer:<input type="text"  name="ans" value="<%= u.getAns() %>"><br><br>		
