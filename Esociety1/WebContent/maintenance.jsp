				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						...
						<!-- 	<li>
							...
							<li  class="active">
								<a href="plan.jsp">plans</a>
							</li>
							<li>
								<a href="contact.jsp">contact us</a>
							</li>
							<li>
								<a href="status.jsp">track service status</a>
							</li>
							<li class="s-bar">
			...
			<div class="container">
				<div class="banner-bottom-main">
					<div class="col-md-4 banner-btmg1">
						...
						<div class="form-text">
						    <h1 id="color"> HOME    MAINTANANCE</h1><br><br>
							<h3>Please!   Pay   Your   Manintanance   Here!</h3><br>
							
							<h3>Your Maintanance Is 1000r Per Month..</h3>
